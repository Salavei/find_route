...
class Route(models.Model):
    ...
    # trains = models.ManyToManyField('trains.Train', on_delete=models.CASCADE, verbose_name='Название поезда')
    trains = models.ManyToManyField('trains.Train', verbose_name='Название поезда')
