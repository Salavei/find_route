...
class AllTestsCase(TestCase):
    ...
    def test_model_city_dublicate(self):
        """ Тестирование возниковноения ошибки при создании дубля города"""
        city = City(name='A')
        with self.assertRaises(ValidationError):
            city.full_clean()

    def test_model_train_dublicate(self):
        """ Тестирование возниковноения ошибки при создании дубля поезда"""
        train = Train(name='t1', from_city=self.city_A, to_city=self.city_B, travel_time=122)
        with self.assertRaises(ValidationError):
            train.full_clean()

    def test_model_train_train_dublicate(self):
        """ Тестирование возниковноения ошибки при создании дубля поезда"""
